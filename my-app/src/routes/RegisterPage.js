...
const [showPassword, setShowPassword] = useState(false);
  ...
  return (
    <div
      className="flex items-center justify-center min-h-[calc(100vh-60px)] px-4"
      style={{ background: "#F7F5F2", fontFamily: "'DM Sans', sans-serif" }}
    >
      <div className="w-full max-w-[400px] bg-white border border-[#E8E6E0] rounded-2xl px-8 py-9 my-8 shadow-sm">
        ...
        <p className="text-[13px] text-gray-400 text-center mb-6">
          Join InkWrite and start sharing your stories
        </p>
    ...
    >
      {showPassword ? (
        ...
        <p className="text-[12.5px] text-gray-400 text-center mt-5">
          ...
          <Link to="/login" className="text-[#B4500A] font-medium hover:underline">
            Sign in
          </Link>
        </p>
      </div>
